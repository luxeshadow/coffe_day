...
<style>
    ...
    * {
    ...
    .nav-dasho a:hover, .nav-dasho button:hover {
...
.mone{
 ...
 @media (max-width: 768px) {
  ...
  .header-container {
    max-width: 100%;
    margin: 0;
    padding: 0 1rem; /* Optionnel : un petit padding si besoin */
  }

  /* Ajuster le padding du main */
  main {
    padding: 0.5rem; /* ou 0 si tu veux aucun espace */
  }
